...
class Weather:
    ...
    def _weather_img(self, a: str):
        ...
        if "雨" in a:
            ...
            file_name = "晴朗.png"
        return os.path.join(os.path.dirname(__file__), "asset", file_name)
    ...
    def _weather(self) -> None:
        ...
        if data[3] != "中国":
            ...
            self.tomorrow_temperature = self._format_str(temperature_7days[1][0])
            self.tomorrow_weather = self._format_str(weather_7days[8][0])
    ...
    def image(self):
        ...
        if self.isTrueCity:
            ...
            tomorrow_temperature = self.tomorrow_temperature
            ...
            # 字体和字号
            # 绝对路径
            font_path = os.path.join(os.path.dirname(__file__), "asset", "1.ttf")
            ...
            background = Image.open(
                os.path.join(os.path.dirname(__file__), "asset", "天气.png")
            )
